# DuinoI2C_ESP
This project is designed to mine Duino-Coin using an ESP8622 as a I2C master and up to ~~10~~ **20** AVR workers with share rate [close](https://github.com/JK-Rolling/DuinoI2C_ESP/discussions/1#discussioncomment-10883377) to USB mining rig setup!
...
11. **Dynamic/Static IP**. Trouble free to access ESP via mDNS or static IP address.
12. **Configurable I2C GPIO**. Choose your own preferred I2C GPIO to optimize your PCB design, or use it on OLED builtin ESP devkit
...
## Contact
Official Duino-Coin Discord server: [discord.gg](https://discord.gg/duino-coin-677615191793467402) look for Developer:`JK Rolling` Beta Tester:`jpx13` `Dark_Hunter`
