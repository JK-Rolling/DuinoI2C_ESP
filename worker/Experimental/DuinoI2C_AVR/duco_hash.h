 ...
 */
  ...
  */
 extern void sha1_init(sha1_ctx_t *state);
  ...
  */
 extern void sha1_nextBlock (sha1_ctx_t *state, const void *block);
  ...
  */
 extern void sha1_lastBlock (sha1_ctx_t *state, const void *block, uint16_t length_b);
  ...
  */ 
 extern void sha1_ctx2hash (void *dest, sha1_ctx_t *state);
  ...
  */ 
 extern void sha1(void *dest, const void *msg, uint32_t length_b);
 
 extern uint32_t w10[10];
 extern uint8_t tempState[20];
